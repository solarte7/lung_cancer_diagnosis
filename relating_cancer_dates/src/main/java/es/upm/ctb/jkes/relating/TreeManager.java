...
public class TreeManager {
	...
	public String getAncestor(String xmlTree, String sentence, String baseNode) {
		int scope=0;        
		String xml = head + "\n" + xmlTree;     
