...
public class TreeManager {
	...
	public static void main(String args[]) {
		...
		String sentence="Ingresa en Hospital Dolors Aleu tras 10semanas de reposo para IQ tras realizar RMN pélvica donde se observa imágen compatible con resto tumoral en tercio inferior de recto com patible con T3 , sin plano de separación con la fascia en la cara inferior y focos de hiperseñal que sugieren tumoración mucinosa.";  
